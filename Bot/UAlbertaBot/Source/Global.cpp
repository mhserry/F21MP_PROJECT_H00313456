...
void UAlbertaBot::Global::awake()
{
    BWAPI::Broodwar->printf(" I AM AWAKE: GLOBAL");
    m_strategyManager->onAwake();
}

void UAlbertaBot::Global::start()
{
    BWAPI::Broodwar->printf(" I AM STARTING: GLOBAL");
    m_strategyManager->onStart();
}

void UAlbertaBot::Global::end(bool isWinner)
{
    BWAPI::Broodwar->printf(" I AM ENDING: GLOBAL");
    m_strategyManager->onEnd(isWinner);
}

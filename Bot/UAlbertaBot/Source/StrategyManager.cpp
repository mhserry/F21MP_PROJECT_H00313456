...
{
    m_controller = new UABController;
}

UAlbertaBot::StrategyManager::~StrategyManager()
{
    delete m_controller;
...
void UAlbertaBot::StrategyManager::onAwake()
{
    BWAPI::Broodwar->printf(" I AM AWAKE: STRATEGY MANAGER");
}

void UAlbertaBot::StrategyManager::onStart()
{
    BWAPI::Broodwar->printf(" I AM STARTED: STRATEGY MANAGER");
    m_controller->OnStart();
}

void UAlbertaBot::StrategyManager::onUpdate()
{
    m_controller->OnUpdate();
}

void UAlbertaBot::StrategyManager::onLateUpdate()
{
...
{
    BWAPI::Broodwar->printf(" I AM ENDING: STRATEGY MANAGER");
    if (!Config::Modules::UsingStrategyIO)
    {
        return;
    }
